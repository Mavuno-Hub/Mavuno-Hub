...
import 'package:mavunohub/constants.dart';
import 'package:mavunohub/util/my_box.dart';
import 'package:mavunohub/util/my_tile.dart';
      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          decoration: BoxDecoration(
            color: Theme.of(context).colorScheme.secondary, // Set the background color of the search bar
